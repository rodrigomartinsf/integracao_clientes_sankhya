...
class ClienteServiceController {
  constructor(jsessionid){
    ...
    this.body = {"serviceName": "CRUDServiceProvider.loadRecords","requestBody": {"dataSet": {"rootEntity": "Parceiro","includePresentationFields": 
                         "N","offsetPage": "0","criteria": {"expression": {"$": "this.CLIENTE = 'S' AND this.CODTAB IS NOT NULL"}},"entity": {"fieldset": {
  ...
  async getAll() {
    ...
    try {
      ...
      let clientes =  Object.values(res.data.responseBody.entities.entity) 
